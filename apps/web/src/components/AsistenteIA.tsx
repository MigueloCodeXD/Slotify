...
export function AsistenteIA() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-50 flex h-[520px] w-[min(400px,92vw)] flex-col overflow-hidden rounded-3xl border border-violet-200 bg-white shadow-2xl">
